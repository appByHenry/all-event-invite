...
/* Next and previous button logic is remaining */
...
$(function () {
    ...
    $(document).on("click", "#prvs_btn_2", function () {
        console.log(this);
        $(".page2").hide(1000);
        $(".page1").show(1000);
        $(".page3").hide(1000);
    ...
    $(document).on("click", "#next_btn_2", function () {
        console.log(this);
        $(".page2").hide(1000);
        $(".page1").hide(1000);
        $(".page3").show(1000);
    ...
    $(document).on("click", "#prvs_btn_3", function () {
        console.log(this);
        $(".page2").show(1000);
        $(".page1").hide(1000);
        $(".page3").hide(1000);
    ...
    $(document).on("click", ".submit_btn", function () {
        ...
        */
        ...
        $(".chkbox_container").each(function () {
        ...
        if(get_submit_flag)
        {
            ...
            if(get_userEmail)
            {
                ...
                $(".chkbox_container").each(function () {
                    ...
                    {
                        var whichEvents = var_choice.data('ceremony');
                        if(whichEvents == "Wedding")
                        {
                            gst_rsvp["wed_cer"] = "Y";
                        }
                        else if(whichEvents == "j_event")
                        {
                            gst_rsvp["j_cer"] = "Y";
                        }
                        else if(whichEvents == "h_event")
                        {
                            gst_rsvp["h_cer"] = "Y";
                        }
                    }
